            ...
            <div id="about-page">
                ...
                <div id="about-me">
                    <div id="message"> 
                        ...
                        <AboutMeBox src={lenaImage} title={'The Girl'}  msg={"This is my fiancé! She is the love of my life, and she is getting a Ph.D. from Claremont Graduate School. She's pretty impressive, and you can find out more about her when she gets her site up and running!"}/>
