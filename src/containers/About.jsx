...
export default class About extends React.Component {
    render() {
        return ( < div id = "about-page" > < Navbar activePage = 'about' / > < Logo / > < Banner header = {
            "Who am I?"
        } /> < div id = "about-me" > < div id = "message" > < AboutMeBox src = {
            meImage
        }
        title = {
            'The Boy'
        ...
        msg = {
            "Hello! I'm Kenley, and I am a Software Engineer. I have a mixed bag of interests" +
                    ...
                    "e world.\nFrom there I went to school to achieve my degree in Computer Science a" +
        ...
        msg = {
            "This is my beautiful wife, and we got married in fall of 2017 (you can see our w" +
        ...
        msg = {
            "This is my dog! He is the brains behind our operation. He's the one who creates " +
